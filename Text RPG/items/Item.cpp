...
Item::Item(const sting& name, const string& description, const sting& flavorText, ItemType type, int price, int effect_value, const sting& associatedClass)
